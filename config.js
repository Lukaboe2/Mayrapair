...
module.exports = {
    ...
    WA_CHANNEL: process.env.WA_CHANNEL || "https://whatsapp.com/channel/0029VbCWYqLL2ATzi4Q01q",
    HOST_LINK: process.env.HOST_LINK || "https://freehost.lukatech.top",
    MSG_FOOTER: process.env.MSG_FOOTER || "> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ ʟᴜᴋᴀʙʀᴀɴᴅ*",
    GC_INVITE: process.env.GC_INVITE || "https://whatsapp.com/channel/0029VbCWYqLL2ATzi401q",
